...
from ml_inspector import plot_precision_recall_curves


class TestPRCurve:
    def test_plot_pr_curves_binary(self, binary_predictions):
        y, y_prob_1, y_prob_2 = binary_predictions
        y_prob = {"Model 1": y_prob_1, "Model 2": y_prob_2}
        class_names = {0: "Class 0", 1: "Class 1"}
        fig = plot_precision_recall_curves(y, y_prob, class_names=class_names)
    ...
    def test_plot_roc_curves_error_single_class(self, binary_predictions):
        ...
        with pytest.raises(ValueError) as ve:
            plot_precision_recall_curves(y, y_prob)
        assert str(ve.value) == (
    ...
    def test_plot_roc_curves_with_array(self, binary_predictions):
        ...
        assert fig.data[1]["name"] == "Random decision: AUC=0.40"
